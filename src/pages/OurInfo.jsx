          ...
          <div className="team-details">
            ...
            <div className="right-team-content">
              <p >
                ...
                customer satisfaction with technological efficiency.<br/>*/}<br/> 
                <span> 
                  <a href="https://www.linkedin.com/in/harsha-bhondwe-java/" target="_blank" rel="noopener noreferrer"> Harsha Bhondwe </a> 
                  </span> – Team Leader, responsible for overseeing project
                management, team coordination, and overall project strategy.
                Harsha also leads the UI design and development, working closely
                with the team to ensure a cohesive user experience.<br/> <br/>

                   
                  <span> 
                    <a href="https://www.linkedin.com/in/dhammashila-gaikwad-20250324a/" target="_blank" rel="noopener noreferrer"> Dhammashila Gaikwad </a> 
                    </span> – Co-Lead
                er, overseeing the backend technologies and
                ...
                <br/><br/>
                 ...
                 <span> 
                  <a href="https://www.linkedin.com/in/shivam-atale-ai-dev/" target="_blank" rel="noopener noreferrer"> Shivam Atale </a> 
